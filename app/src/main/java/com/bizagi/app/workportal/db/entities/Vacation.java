...
public class Vacation extends BaseModel {
    ...
    @PrimaryKey private String  activityId;

    @SerializedName("activity")
    @Column private String  activity;

    @SerializedName("processId")
    @Column private String  processId;

    @SerializedName("process")
    @Column private String  process;

    @SerializedName("employee")
    @Column private String  employee;

    @SerializedName("beginDate")
    @Column private String  beginDate;
    ...
    @Column private String  lastVacationOn;
